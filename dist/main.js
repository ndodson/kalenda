...
require("@swc/helpers/lib/_async_to_generator.js");
...
import "3f7b2fe5d2c34f8f:@swc/helpers/lib/_object_spread.js:esm";
import "3f7b2fe5d2c34f8f:@swc/helpers/lib/_object_spread_props.js:esm";
...
import "63103f0ef67d319d:@swc/helpers/lib/_async_to_generator.js:esm";





import "bf7b38bce41ca3dd:@swc/helpers/lib/_to_consumable_array.js:esm";
...
var $28306200f69a6328$export$64d4bb1347f411e8 = function(date, zone, deviceTimezone) {
    ...
    if (isFloatingDatetime) {
        var dateFloating = (0, $cw6c3$luxon.DateTime).fromISO(dateString, {
            zone: $28306200f69a6328$var$UTC_TIMEZONE
        });
        return dateFloating.toUTC().toISO();
    }
    var thisDate = (0, $cw6c3$luxon.DateTime).fromISO(dateString);
...
var $bf7b38bce41ca3dd$export$f5a7c490b6f9fbc4 = function(dateObj) {
    return dateObj.isValid ? dateObj.toFormat("dd-MM-yyyy") : (0, $cw6c3$luxon.DateTime).fromISO(dateObj).toFormat("dd-MM-yyyy");
};
...
var $bf7b38bce41ca3dd$export$6d0e4c4a8ffb9c2b = function(events) {
    ...
    Object.entries(events).forEach(function(keyValue) {
        ...
        result = (0, $bf7b38bce41ca3dd$import$5a5c6451aa60633f$2e2bcd8739ae039)(result).concat((0, $bf7b38bce41ca3dd$import$5a5c6451aa60633f$2e2bcd8739ae039)(eventsItems));
    });
    return result;
};
var $bf7b38bce41ca3dd$export$3d836550a1b0c60b = function(events, timezone) {
    ...
    events === null || events === void 0 ? void 0 : events.forEach(function(item) {
        var dateKey = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(item.startAt, item.timezoneStartAt || timezone).toFormat("dd-MM-yyyy");
        if (result[dateKey]) result[dateKey] = (0, $bf7b38bce41ca3dd$import$5a5c6451aa60633f$2e2bcd8739ae039)(result[dateKey]).concat([
            item
        ]);
        else result[dateKey] = [
            item
...
var $bf7b38bce41ca3dd$export$d9b78e6f3f437c1f = function(timeFormat) {
    ...
    } else if (timeFormat === (0, $e4750b0ebeed8e48$export$c4e1e4e065ff5bd8).H_12) for(var i1 = 0; i1 < 24; i1++){
...
var $d49542164c9bae14$var$LuxonHelper = {
    parseToDateTime: function(date) {
        return typeof date === "string" ? (0, $cw6c3$luxon.DateTime).fromISO(date) : date;
    },
    ...
    isBefore: function(dateA, dateB) {
        return (0, $cw6c3$luxon.DateTime).fromISO(dateB).valueOf() - (0, $cw6c3$luxon.DateTime).fromISO(dateA).valueOf() > 0;
    },
    ...
    isToday: function(dateA) {
        var todayDate = (0, $cw6c3$luxon.DateTime).local();
    ...
    toUtcString: function(date) {
        return (0, $cw6c3$luxon.DateTime).fromISO(date).toUTC().toISO();
    },
    toUtc: function(date) {
        return date.toUTC().toISO();
    },
    setTimezone: function(dateString, timezone) {
        return (0, $cw6c3$luxon.DateTime).fromISO(dateString).setZone(timezone).toString();
    },
    toHumanDate: function(dateString) {
        return (0, $cw6c3$luxon.DateTime).fromISO(dateString).toFormat("d LLL yyyy hh:mm");
    }
};
...
var $1500da26cef85c66$export$b34cdd4783897766 = function(date, setSelectedDate, isGoingForward) {
    ...
    else if (isGoingForward) for(var i1 = 1; i1 <= 3; i1++)days.push(date.plus({
        days: i1
    }));
    else for(var i2 = 3; i2 > 0; i2--)days.push(date.minus({
        days: i2
    }));
    // Set state
...
var $1500da26cef85c66$export$f82b43a5dad4749 = function(refDate) {
    var firstDayInMonth = (0, $d49542164c9bae14$export$2e2bcd8739ae039).getFirstDayOfMonth(refDate);
...
var $1500da26cef85c66$export$be98daea68e5bd4 = function(date, weekDayStart) {
    ...
    var firstDayOfCurrentMonth = (0, $d49542164c9bae14$export$2e2bcd8739ae039).getFirstDayOfMonth(date);
    var firstWeekOfCurrentMonth = $1500da26cef85c66$export$69ac73875782844e(firstDayOfCurrentMonth, (0, $e4750b0ebeed8e48$export$ec9758e21af63072).WEEK, weekDayStart, undefined);
...
var $1500da26cef85c66$export$431753531f5fca31 = function(item) {
    return typeof item === "string" ? (0, $cw6c3$luxon.DateTime).fromISO(item) : item;
};
...
var $63103f0ef67d319d$export$3d0db7ed812b6b3f = function(calendarDays, calendarView, direction, weekDayStart, dispatchContext) {
    ...
    var newCalendarDays = (0, $1500da26cef85c66$export$20dc9138dd5b1a6a)(direction, calendarDays, calendarView, setSelectedDate, weekDayStart);
...
var $63103f0ef67d319d$export$28b655052872eb26 = function() {
    var _ref = (0, $63103f0ef67d319d$import$f5e139539d226ac3$2e2bcd8739ae039)((0, ($parcel$interopDefault($cw6c3$regeneratorruntime))).mark(function _callee(selectedView, setContext, weekDayStart) {
        var dateNow, _args = arguments;
        return (0, ($parcel$interopDefault($cw6c3$regeneratorruntime))).wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    dateNow = _args.length > 3 && _args[3] !== void 0 ? _args[3] : (0, $cw6c3$luxon.DateTime).now();
    ...
    return function navigateToToday(selectedView, setContext, weekDayStart) {
...
import "2c06f9532bb9aaf9:@swc/helpers/lib/_object_spread.js:esm";
import "2c06f9532bb9aaf9:@swc/helpers/lib/_object_spread_props.js:esm";
import "2c06f9532bb9aaf9:@swc/helpers/lib/_sliced_to_array.js:esm";


import "65553fbba1d6d65b:@swc/helpers/lib/_sliced_to_array.js:esm";



import "3886b97a1526edd3:@swc/helpers/lib/_sliced_to_array.js:esm";




import "585762b051d85803:@swc/helpers/lib/_object_spread.js:esm";
import "585762b051d85803:@swc/helpers/lib/_object_spread_props.js:esm";




var $585762b051d85803$export$c212dd23f1f0a1e3 = function(eventA, eventB, timezone) {
    var startAtFirst = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(eventA.startAt, eventA.timezoneStartAt, timezone);
    var endAtFirst = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(eventA.endAt, eventA.timezoneStartAt, timezone);
    var startAtSecond = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(eventB.startAt, eventB.timezoneStartAt, timezone);
    var endAtSecond = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(eventB.endAt, eventB.timezoneStartAt, timezone);
...
var $585762b051d85803$var$adjustForMinimalHeight = function(eventA, eventB, hourHeight) {
    var result = {
        eventA: (0, $585762b051d85803$import$edcaf86a4f533110$2e2bcd8739ae039)({}, eventA),
        eventB: (0, $585762b051d85803$import$edcaf86a4f533110$2e2bcd8739ae039)({}, eventB)
    };
...
var $585762b051d85803$export$6a8cd07afb93412f = function(events, baseWidth, config, selectedView, dateKey) {
    ...
    var tableWidth = baseWidth / (0, $1500da26cef85c66$export$f16d393a3268e3f3)(selectedView);
    var tableSpace = tableWidth / 100 * (0, $88a08af890f49243$export$b4e2ba6756dec2c);
    if (events) {
    ...
    var partialResult = result.map(function(item) {
        var ref;
        // full event width
        if ((ref = item.meta) === null || ref === void 0 ? void 0 : ref.isFullWidth) return (0, $585762b051d85803$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $585762b051d85803$import$edcaf86a4f533110$2e2bcd8739ae039)({}, item), {
            width: Math.round(item.width - tableSpace)
        });
        else if (item.offsetLeft > 0) return (0, $585762b051d85803$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $585762b051d85803$import$edcaf86a4f533110$2e2bcd8739ae039)({}, item), {
            width: Math.round(item.width),
            offsetLeft: item.offsetLeft - tableSpace,
            zIndex: item.zIndex ? item.zIndex + 2 : 2
        });
        else return (0, $585762b051d85803$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $585762b051d85803$import$edcaf86a4f533110$2e2bcd8739ae039)({}, item), {
            width: Math.round(item.width)
        });
    });
...
var $585762b051d85803$export$f917769c218c90fd = function(event, day, timezone) {
    var dateStart = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(event.startAt, event.timezoneStartAt || timezone);
    var dateEnd = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(event.endAt, event.timezoneStartAt || timezone);
    var dayTruncated = (0, $1500da26cef85c66$export$431753531f5fca31)(day).set({
        hour: 0,
        minute: 0,
        millisecond: 0,
        second: 0
...
var $3886b97a1526edd3$export$45a69314cf48a3eb = function(props) {
    return {
        hourHeight: props.hourHeight || (0, $88a08af890f49243$export$1c9a1263a0d343f4),
...
var $3886b97a1526edd3$var$ConfigLayer = function(props) {
    var ref;
    var ref1 = (0, $3886b97a1526edd3$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), isReady = ref1[0], setIsReady = ref1[1];
    var ref2 = (0, $3886b97a1526edd3$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), dispatch = ref2[1];
    ...
    (0, $cw6c3$react.useEffect)(function() {
        var eventsFiltered = (0, $585762b051d85803$export$75fe04c694e7ab2e)(props.events, props.calendarIDsHidden);
...
import "e7acfb653c6fbfca:@swc/helpers/lib/_object_spread.js:esm";
import "e7acfb653c6fbfca:@swc/helpers/lib/_object_spread_props.js:esm";
// tslint:disable-next-line:cyclomatic-complexity
var $e7acfb653c6fbfca$var$Reducer = function(state, action) {
    switch(action.type){
        case "initialView":
            return (0, $e7acfb653c6fbfca$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $e7acfb653c6fbfca$import$edcaf86a4f533110$2e2bcd8739ae039)({}, state), {
...
var $65553fbba1d6d65b$var$StoreProvider = function(param) {
    ...
    var initialContext = {
        ...
        config: (0, $3886b97a1526edd3$export$45a69314cf48a3eb)({}),
    ...
    var ref = (0, $65553fbba1d6d65b$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useReducer)((0, $e7acfb653c6fbfca$export$2e2bcd8739ae039), initialContext), 2), store = ref[0], dispatch = ref[1];
...
import "2c4fe1f6b84a6784:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $2c4fe1f6b84a6784$export$3aee49006f13db09 = function() {
    var ref = (0, $2c4fe1f6b84a6784$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)($2c4fe1f6b84a6784$export$3c49c185de0c2bfc()), 2), width = ref[0], setWidth = ref[1];
    // Get width on init
    (0, $cw6c3$react.useEffect)(function() {
...
var $2c4fe1f6b84a6784$export$30dc190df7e420c4 = function() {
    var ref = (0, $2c4fe1f6b84a6784$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)($2c4fe1f6b84a6784$export$c08559766941f856()), 2), height = ref[0], setHeight = ref[1];
    // Get height on init
    (0, $cw6c3$react.useEffect)(function() {
...
import "ae9d5d34ac1cc52f:@swc/helpers/lib/_sliced_to_array.js:esm";
...
import "ecf585202d453fcb:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $ecf585202d453fcb$var$DateWeekDay = function(props) {
    ...
    var ref = (0, $ecf585202d453fcb$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    var selectedView = store.selectedView, style = store.style;
    var isDayToday = (0, $d49542164c9bae14$export$2e2bcd8739ae039).isToday(day);
    var isMonthView = selectedView === (0, $e4750b0ebeed8e48$export$ec9758e21af63072).MONTH;
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
        ...
        children: /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
            ...
            children: /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("p", {
                className: "Kalend__text Kalend__CalendarHeaderDates__text ".concat(selectedView === (0, $e4750b0ebeed8e48$export$ec9758e21af63072).MONTH ? "Kalend__CalendarHeaderDates__text-size-small" : ""),
                style: {
...
import "0689dc746d054cae:@swc/helpers/lib/_sliced_to_array.js:esm";



var $0689dc746d054cae$var$DayOfWeekText = function(props) {
    var width = props.width, day = props.day;
    var ref = (0, $0689dc746d054cae$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
...
import "b852c5f3008abacb:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $79dca703cc699b4f$export$633076c346814fbe = function(type, day, event, store, setLayout, index) {
    ...
    if (type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).NORMAL && day) {
        var ref;
        var formattedDayString = (0, $bf7b38bce41ca3dd$export$6a8d31c8b7f17aa5)(day);
...
import "f7dc25aaa4235907:@swc/helpers/lib/_sliced_to_array.js:esm";


var $f7dc25aaa4235907$var$timeout;
var $f7dc25aaa4235907$var$ButtonBase = function(props) {
    var id = props.id, onClick = props.onClick, text = props.text, className = props.className, style = props.style, children = props.children, propagation = props.propagation, disabled = props.disabled, onClickFromParent = props.onClickFromParent, onMouseDown = props.onMouseDown, onMouseUp = props.onMouseUp, onMouseMove = props.onMouseMove, onTouchEnd = props.onTouchEnd;
    var buttonRef = (0, $cw6c3$react.useRef)(null);
    var ref = (0, $f7dc25aaa4235907$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), isPressed = ref[0], setIsPressed = ref[1];
    var ref1 = (0, $f7dc25aaa4235907$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)({}), 2), spanStyle = ref1[0], setSpanStyle = ref1[1];
...
var $8304c40ecd0ca62c$var$EventSummary = function(props) {
    ...
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsxs)("p", {
...
import "5293df8efc30aa85:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $5293df8efc30aa85$var$formatEventTimeV2 = function(event, timeFormat, timezone) {
    ...
    var startAtDateTime = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(startAt, timezoneStartAt, timezone);
    var endAtDateTime = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(endAt, timezoneStartAt, timezone);
    return {
...
var $5293df8efc30aa85$var$EventTime = function(props) {
    ...
    var ref = (0, $5293df8efc30aa85$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
...
import "66c3795c5fc7507d:@swc/helpers/lib/_define_property.js:esm";
import "66c3795c5fc7507d:@swc/helpers/lib/_object_spread.js:esm";
import "66c3795c5fc7507d:@swc/helpers/lib/_object_spread_props.js:esm";
var $66c3795c5fc7507d$var$StateReducer = function(state, action) {
    // Replace whole state
    if (!action.payload) return (0, $66c3795c5fc7507d$import$edcaf86a4f533110$2e2bcd8739ae039)({}, state, action);
    var _payload = action.payload, stateName = _payload.stateName, type = _payload.type, data = _payload.data;
    type;
    return (0, $66c3795c5fc7507d$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $66c3795c5fc7507d$import$edcaf86a4f533110$2e2bcd8739ae039)({}, state), (0, $66c3795c5fc7507d$import$d76420afe0f7f8c4$2e2bcd8739ae039)({}, stateName, data));
};
...
var $b852c5f3008abacb$var$EventButton = function(props) {
    var item = props.item, type = props.type, _day = props.day, day = _day === void 0 ? (0, $cw6c3$luxon.DateTime).now() : _day, index = props.index;
    var event = item.event;
    var startAt = event.startAt;
    var ref = (0, $b852c5f3008abacb$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useReducer)((0, $66c3795c5fc7507d$export$2e2bcd8739ae039), (0, $79dca703cc699b4f$export$2b35b885b699e674)), 2), state = ref[0], dispatchState = ref[1];
    ...
    var offsetLeftRef = (0, $cw6c3$react.useRef)(state.offsetLeft);
    var xShiftIndexRef = (0, $cw6c3$react.useRef)(0);
    var yShiftIndexRef = (0, $cw6c3$react.useRef)(0);
    var draggingRef = (0, $cw6c3$react.useRef)(false);
    var eventWasChangedRef = (0, $cw6c3$react.useRef)(false);
    var ref1 = (0, $b852c5f3008abacb$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref1[0], dispatch = ref1[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    var heightHook = (0, $2c4fe1f6b84a6784$export$30dc190df7e420c4)();
    ...
    var columnWidth = width / (type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).MONTH ? 7 : calendarDays.length);
    var eventColor = event.color ? (0, $1500da26cef85c66$export$2d5ed1e6bc597003)(event.color, isDark) : "indigo";
    var style = {
        position: type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).AGENDA || type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).SHOW_MORE_MONTH ? "relative" : "absolute",
        height: state.height !== null ? state.height : item.height || (0, $cw6c3$kalendlayoutconstants.MONTH_EVENT_HEIGHT),
   ...
   */ var onMouseDown = function(e) {
    ...
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsxs)((0, $f7dc25aaa4235907$export$2e2bcd8739ae039), {
        ...
        isDark: isDark,
        style: style,
        className: "Kalend__Event-".concat(type, " ").concat(state.isDragging ? "Kalend__EventButton__elevation" : ""),
        ...
        children: [
            type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).MONTH || type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).HEADER ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $e4c1f2269414489f$export$2e2bcd8739ae039), {
                event: event,
                isDark: isDark,
                type: type
            }) : null,
            ...
            type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).AGENDA ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $82d351ff4940fae4$export$2e2bcd8739ae039), {
                event: event,
                isDark: isDark,
                type: type
            }) : null,
            type === (0, $e4750b0ebeed8e48$export$76a2e4c433c23bb9).SHOW_MORE_MONTH ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $54523a3171a39713$export$2e2bcd8739ae039), {
                event: event,
                isDark: isDark,
                type: type
            }) : null
...
var $86ca9f6752cc056e$var$renderEvents = function(events) {
    ...
    var sortedEvents = events === null || events === void 0 ? void 0 : events.sort(function(a, b) {
        return (0, $cw6c3$luxon.DateTime).fromISO(a.startAt).toMillis() - (0, $cw6c3$luxon.DateTime).fromISO(b.startAt).toMillis();
    });
...
var $ae9d5d34ac1cc52f$var$renderAgendaEvents = function(events, calendarDays) {
    return calendarDays.map(function(calendarDay) {
        var hasEvents = !!events[calendarDay.toFormat((0, $d49542164c9bae14$export$74b2237eca26435b))];
        if (hasEvents) return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $86ca9f6752cc056e$export$2e2bcd8739ae039), {
            day: calendarDay,
...
var $ae9d5d34ac1cc52f$var$AgendaView = function(props) {
    ...
    var ref = (0, $ae9d5d34ac1cc52f$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), wasInit = ref[0], setWasInit = ref[1];
    var ref1 = (0, $ae9d5d34ac1cc52f$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(null), 2), calendarContent = ref1[0], setCalendarContent = ref1[1];
    var ref2 = (0, $ae9d5d34ac1cc52f$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref2[0], dispatch = ref2[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    var height = (0, $2c4fe1f6b84a6784$export$30dc190df7e420c4)();
    var hasExternalLayout = eventLayouts !== undefined;
    (0, $cw6c3$react.useEffect)(function() {
        if (!hasExternalLayout) {
            (0, ($parcel$interopDefault($cw6c3$kalendlayout)))({
                events: events,
    ...
    (0, $cw6c3$react.useEffect)(function() {
        ...
        if (wasInit) {
            if (!hasExternalLayout) (0, ($parcel$interopDefault($cw6c3$kalendlayout)))({
                events: events,
                selectedView: (0, $e4750b0ebeed8e48$export$ec9758e21af63072).AGENDA,
                height: height,
                width: width,
...
import "21db0de5ba63f204:@swc/helpers/lib/_async_to_generator.js:esm";
import "21db0de5ba63f204:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $cea2a6b325f4edcd$var$CalendarIcon = function(props) {
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("svg", {
...
var $1c7a61445362ebf7$export$a9676248d3e54baf = {
    ChevronDown: (0, $de758c447aa9231a$export$2e2bcd8739ae039),
    ChevronLeft: (0, $2764ed95df1a4c11$export$2e2bcd8739ae039),
    ChevronRight: (0, $ddaf3c6577962ab4$export$2e2bcd8739ae039),
    Calendar: (0, $cea2a6b325f4edcd$export$2e2bcd8739ae039),
    More: (0, $e5981d21af543faf$export$2e2bcd8739ae039)
};
...
import "224cea852abf103b:@swc/helpers/lib/_sliced_to_array.js:esm";



var $224cea852abf103b$var$ButtonIcon = function(props) {
    var ref = (0, $224cea852abf103b$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), isPressed = ref[0], setIsPressed = ref[1];
    ...
    var IconElement = /*#__PURE__*/ (0, ($parcel$interopDefault($cw6c3$react))).cloneElement(children, {
...
import "95f304efc96ef4c9:@swc/helpers/lib/_sliced_to_array.js:esm";
...
import "6188babcb8da6286:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $6188babcb8da6286$var$HeaderCalendarButton = function(props) {
    ...
    var ref = (0, $6188babcb8da6286$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    ...
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $f7dc25aaa4235907$export$2e2bcd8739ae039), {
        className: (0, $bf7b38bce41ca3dd$export$cf733e3bd5432c08)(buttonClassName, isMobile || isForcedMobile),
        isDark: isDark,
...
var $95f304efc96ef4c9$var$CalendarViewDropdown = function(props) {
    ...
    var ref = (0, $95f304efc96ef4c9$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), isOpen = ref[0], setOpen = ref[1];
    var ref1 = (0, $95f304efc96ef4c9$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref1[0];
...
import "d2b46716a1f3a2a1:@swc/helpers/lib/_sliced_to_array.js:esm";



var $d2b46716a1f3a2a1$var$DesktopLayout = function(props) {
    var children = props.children;
    var ref = (0, $d2b46716a1f3a2a1$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
...
import "e8a58db0b7f8e0e1:@swc/helpers/lib/_sliced_to_array.js:esm";
 ...
 */ var $e8a58db0b7f8e0e1$var$HeaderCalendarTitle = function(props) {
    ...
    var ref = (0, $e8a58db0b7f8e0e1$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
...
import "60dd5ae4676e5d2e:@swc/helpers/lib/_sliced_to_array.js:esm";



var $60dd5ae4676e5d2e$var$MobileLayout = function(props) {
    var children = props.children, style = props.style;
    var ref = (0, $60dd5ae4676e5d2e$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    var isMobile = store.isMobile;
    return isMobile ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
 ...
 */ var $21db0de5ba63f204$var$CalendarDesktopNavigation = function(props) {
    var ref = (0, $21db0de5ba63f204$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref[0], dispatch = ref[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    var ref1 = (0, $21db0de5ba63f204$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(true), 2), isFullNavigationHidden = ref1[0], setIsFullNavigationHidden = ref1[1];
    var titleDate = (0, $cw6c3$luxon.DateTime).fromISO(selectedDate);
    ...
    var navigateBackwards = function() {
        var _ref = (0, $21db0de5ba63f204$import$f5e139539d226ac3$2e2bcd8739ae039)((0, ($parcel$interopDefault($cw6c3$regeneratorruntime))).mark(function _callee() {
            return (0, ($parcel$interopDefault($cw6c3$regeneratorruntime))).wrap(function _callee$(_ctx) {
                while(1)switch(_ctx.prev = _ctx.next){
                    case 0:
            ...
            return (0, ($parcel$interopDefault($cw6c3$regeneratorruntime))).wrap(function _callee$(_ctx) {
                while(1)switch(_ctx.prev = _ctx.next){
                    case 0:
                        ...
                        _ctx.next = 4;
                        return (0, $63103f0ef67d319d$export$28b655052872eb26)(selectedView, setContext, weekDayStart, (0, $cw6c3$luxon.DateTime).now());
                    case 4:
                    case "end":
                        return _ctx.stop();
                }
...
import "58f20473f1f0067a:@swc/helpers/lib/_sliced_to_array.js:esm";




import "2d4e959c42b07254:@swc/helpers/lib/_sliced_to_array.js:esm";
...
import "0c3afbe9f694dbf0:@swc/helpers/lib/_sliced_to_array.js:esm";




import "2a3380b4418c18d4:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $2a3380b4418c18d4$var$CalendarHeaderCol = function(props) {
    var children = props.children;
    var ref = (0, $2a3380b4418c18d4$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
 ...
 */ var $0c3afbe9f694dbf0$var$CalendarHeaderDates = function(props) {
    var ref = (0, $0c3afbe9f694dbf0$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    ...
    var colWidth = (0, $bf7b38bce41ca3dd$export$b32ccbc1ca23891)(width, isMobile, selectedView) / daysNum;
...
import "386a7bec00aa15a1:@swc/helpers/lib/_sliced_to_array.js:esm";
 ...
 */ var $386a7bec00aa15a1$var$CalendarHeaderWeekDays = function(props) {
    ...
    var ref = (0, $386a7bec00aa15a1$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    ...
    var isMonthView = selectedView === (0, $e4750b0ebeed8e48$export$ec9758e21af63072).MONTH;
    var colWidth = isMonthView ? width / daysNum : (0, $bf7b38bce41ca3dd$export$b32ccbc1ca23891)(width, isMobile, selectedView) / daysNum;
    var weekDays = weekDayStart === (0, $e4750b0ebeed8e48$export$5a05f7ffc0500403).SUNDAY ? (0, $1500da26cef85c66$export$88e7cb308ec58e48) : (0, $1500da26cef85c66$export$933d53aed74a6ef0);
    var renderDaysText = function() {
        ...
        return days.map(function(calendarDay) {
            return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $0689dc746d054cae$export$2e2bcd8739ae039), {
                day: calendarDay,
                width: colWidth
            }, calendarDay.toString());
        });
...
import "a214409a8fa5f760:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $a214409a8fa5f760$var$CalendarHeaderWrapper = function(props) {
    ...
    var ref = (0, $a214409a8fa5f760$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    var width = store.width, isDark = store.isDark;
    var headerStyle = {
        paddingLeft: isMonthView ? 0 : (0, $88a08af890f49243$export$447c5938f45c45a5),
        width: width
    };
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
        className: (0, $bf7b38bce41ca3dd$export$b7a9dbebc395fc65)("Kalend__CalendarHeaderCol", isDark),
...
var $2d4e959c42b07254$var$CalendarHeaderDays = function(props) {
    ...
    var ref = (0, $2d4e959c42b07254$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
...
import "89f45f2bf33757e0:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $89f45f2bf33757e0$var$CalendarHeaderEvents = function() {
    var ref = (0, $89f45f2bf33757e0$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref[0], dispatch = ref[1];
    ...
    var column = width / (0, $1500da26cef85c66$export$f16d393a3268e3f3)(selectedView);
    var colWidthStyle = {
        width: column
    };
    ...
    var ref1 = (0, $89f45f2bf33757e0$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(null), 2), headerEvents = ref1[0], setHeaderEvents = ref1[1];
    var headerStyle = {
    ...
    (0, $cw6c3$react.useEffect)(function() {
        // setTimeout(() => {
        setContext("height", (0, $2c4fe1f6b84a6784$export$c08559766941f856)());
    // }, 600);
    }, [
...
var $58f20473f1f0067a$var$CalendarHeader = function() {
    var ref = (0, $58f20473f1f0067a$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    var isDark = store.isDark, width = store.width, selectedView = store.selectedView;
    var isDayView = selectedView === (0, $e4750b0ebeed8e48$export$ec9758e21af63072).DAY;
    var isMonthView = selectedView === (0, $e4750b0ebeed8e48$export$ec9758e21af63072).MONTH;
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsxs)("div", {
        ...
        children: [
            ...
            !isMonthView && store.headerLayout ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $89f45f2bf33757e0$export$2e2bcd8739ae039), {}) : null
        ]
    });
};
...
import "f89b7b16d8022e68:@swc/helpers/lib/_object_spread.js:esm";
import "f89b7b16d8022e68:@swc/helpers/lib/_object_spread_props.js:esm";
import "f89b7b16d8022e68:@swc/helpers/lib/_sliced_to_array.js:esm";



var $f89b7b16d8022e68$var$CalendarTableLayoutLayer = function(props) {
    var ref = (0, $f89b7b16d8022e68$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    ...
    var ref1 = (0, $f89b7b16d8022e68$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), isMounted = ref1[0], setIsMounted = ref1[1];
    (0, $cw6c3$react.useEffect)(function() {
        var rootEl = document.querySelector(".Kalend__Calendar__table");
    ...
    (0, $cw6c3$react.useLayoutEffect)(function() {
        if (callbacks.onStateChange && isMounted) {
            var data = {
                selectedView: selectedView,
                calendarDays: calendarDays,
                range: (0, $f89b7b16d8022e68$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $f89b7b16d8022e68$import$edcaf86a4f533110$2e2bcd8739ae039)({}, (0, $1500da26cef85c66$export$fef151b94550e9f5)(calendarDays)), {
                    direction: direction
                }),
                width: width,
                config: config,
...
import "be26fc4a0d3aa4a6:@swc/helpers/lib/_sliced_to_array.js:esm";
...
import "db9a28e0bd6328b4:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $db9a28e0bd6328b4$var$renderHours = function(width, hourHeight, isDark, timeFormat) {
    return (0, $bf7b38bce41ca3dd$export$d9b78e6f3f437c1f)(timeFormat).map(function(hour) {
        return hour === "00" || hour === "24" ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
...
var $db9a28e0bd6328b4$var$CalendarBodyHours = function() {
    var ref = (0, $db9a28e0bd6328b4$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
...
import "17d79b7922eec8b8:@swc/helpers/lib/_sliced_to_array.js:esm";
...
import "1a47dae3ce368d80:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $1a47dae3ce368d80$var$CurrentHourLine = function() {
    var ref = (0, $1a47dae3ce368d80$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    var config = store.config, colors = store.colors;
    var currentTime = (0, $cw6c3$luxon.DateTime).now();
    var wrapperStyle = {
    ...
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
                className: (0, $bf7b38bce41ca3dd$export$b7a9dbebc395fc65)("Kalend__CurrentHourLine__circle", false),
                style: {
            ...
            /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
                ...
                className: (0, $bf7b38bce41ca3dd$export$b7a9dbebc395fc65)("Kalend__CurrentHourLine__line", false)
            })
        ]
    });
};
...
var $17d79b7922eec8b8$var$DaysViewOneDay = function(props) {
    ...
    var ref1 = (0, $17d79b7922eec8b8$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref1[0];
    ...
    var isToday = (0, $d49542164c9bae14$export$2e2bcd8739ae039).isToday(day);
    var isFirstDay = index === 0;
    var dataForDay = data;
    var dateNow = (0, $cw6c3$luxon.DateTime).local();
    var nowPosition = dateNow.diff((0, $cw6c3$luxon.DateTime).local().set({
        hour: 0,
        minute: 0,
        second: 0
    ...
    return ((ref = store.daysViewLayout) === null || ref === void 0 ? void 0 : ref[(0, $bf7b38bce41ca3dd$export$6a8d31c8b7f17aa5)(day)]) ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsxs)("div", {
        ...
        children: [
            isToday && showTimeLine ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $1a47dae3ce368d80$export$2e2bcd8739ae039), {}) : null,
            dataForDay && dataForDay.length > 0 ? $17d79b7922eec8b8$var$renderEvents(dataForDay, day) : null
        ]
    }, day.toString()) : /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
        id: "Kalend__day__".concat(day.toString()),
        style: oneDayStyle,
        className: !isFirstDay ? (0, $bf7b38bce41ca3dd$export$b7a9dbebc395fc65)("Kalend__DayViewOneDay", isDark) : "Kalend__DayViewOneDay",
        onClick: handleEventClickInternal
...
import "b867b3e906676344:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $b867b3e906676344$var$renderVerticalLines = function(calendarDays, width, height, hourHeight, isDark, isMobile, selectedView) {
    var columnWidth = (0, $bf7b38bce41ca3dd$export$b32ccbc1ca23891)(width, isMobile, selectedView) / calendarDays.length;
...
var $b867b3e906676344$var$DaysViewVerticalLines = function() {
    var ref = (0, $b867b3e906676344$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    ...
    var verticalLines = $b867b3e906676344$var$renderVerticalLines(selectedView === (0, $e4750b0ebeed8e48$export$ec9758e21af63072).MONTH ? calendarDays.slice(0, 7) : calendarDays, width, height, config.hourHeight, isDark, isMobile, selectedView);
...
var $be26fc4a0d3aa4a6$var$renderOneDay = function(calendarDays, events, sequence) {
    return calendarDays.map(function(calendarDay, index) {
        var formattedDayString = (0, $bf7b38bce41ca3dd$export$6a8d31c8b7f17aa5)(calendarDay);
...
var $be26fc4a0d3aa4a6$var$DaysViewTable = function(props) {
    ...
    var ref = (0, $be26fc4a0d3aa4a6$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), wasInit = ref[0], setWasInit = ref[1];
    var ref1 = (0, $be26fc4a0d3aa4a6$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(null), 2), calendarContent = ref1[0], setCalendarContent = ref1[1];
    var ref2 = (0, $be26fc4a0d3aa4a6$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref2[0], dispatch = ref2[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    var height = (0, $2c4fe1f6b84a6784$export$30dc190df7e420c4)();
    var widthHook = (0, $2c4fe1f6b84a6784$export$3aee49006f13db09)();
    var style = {
    ...
    var adjustScrollPosition = function() {
        ...
        currentElement.scrollTop = (0, $cw6c3$luxon.DateTime).now().hour * 60;
    };
    (0, $cw6c3$react.useEffect)(function() {
    ...
    (0, $cw6c3$react.useLayoutEffect)(function() {
        if (wasInit) {
            if (!hasExternalLayout) (0, ($parcel$interopDefault($cw6c3$kalendlayout)))({
                events: events,
                width: widthHook - (0, $bf7b38bce41ca3dd$export$76c69f043295405f)(selectedView),
                height: height,
                calendarDays: calendarDays,
                config: store.config,
                isMobile: isMobile,
...
import "4e630ae36e00686b:@swc/helpers/lib/_sliced_to_array.js:esm";




import "0491e7111fa05a9f:@swc/helpers/lib/_object_spread.js:esm";
import "0491e7111fa05a9f:@swc/helpers/lib/_object_spread_props.js:esm";
import "0491e7111fa05a9f:@swc/helpers/lib/_sliced_to_array.js:esm";
import "0491e7111fa05a9f:@swc/helpers/lib/_to_consumable_array.js:esm";





import "c57d36d3233524f5:@swc/helpers/lib/_object_spread.js:esm";
import "c57d36d3233524f5:@swc/helpers/lib/_object_spread_props.js:esm";
import "c57d36d3233524f5:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $c57d36d3233524f5$export$ca41440b93b2a001 = function(event, timezone) {
    return (0, $c57d36d3233524f5$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $c57d36d3233524f5$import$edcaf86a4f533110$2e2bcd8739ae039)({}, event), {
...
var $c57d36d3233524f5$export$ebf0f5b49a0a9e59 = function(events, width, calendarDays, timezone, setContext) {
    ...
    // form them to row
    var tableSpace = (width + (0, $88a08af890f49243$export$447c5938f45c45a5)) / 100 * (0, $88a08af890f49243$export$b4e2ba6756dec2c);
    var result = [];
    var usedEvents = [];
    ...
    (ref = Object.entries(events)) === null || ref === void 0 ? void 0 : ref.map(function(param) {
        var _param = (0, $c57d36d3233524f5$import$a521aa921bda7687$2e2bcd8739ae039)(param, 2), key = _param[0], items = _param[1];
        // @ts-ignore
        items.forEach(function(item) {
            // filter only relevant events
            if (item.allDay || (0, $bf7b38bce41ca3dd$export$23783ea7bfe28abd)(item)) {
                var isInRange = (0, $585762b051d85803$export$3a6eb9efca632dee)(item, calendarDays, timezone);
    ...
    headerEventsFiltered === null || headerEventsFiltered === void 0 ? void 0 : headerEventsFiltered.forEach(function(event) {
        ...
        headerEventsFiltered.forEach(function(eventToCompare) {
            ...
            var isOverlapping = (0, $585762b051d85803$export$c212dd23f1f0a1e3)($c57d36d3233524f5$export$ca41440b93b2a001(event, timezone), $c57d36d3233524f5$export$ca41440b93b2a001(eventToCompare, timezone), timezone);
            ...
            if (!isOverlapping) {
                ...
                rowWithNotOverlappingEvents.forEach(function(itemFromRow) {
                    var isOverlappingAll = (0, $585762b051d85803$export$c212dd23f1f0a1e3)($c57d36d3233524f5$export$ca41440b93b2a001(itemFromRow, timezone), $c57d36d3233524f5$export$ca41440b93b2a001(eventToCompare, timezone), timezone);
    ...
    result.forEach(function(events, index) {
        events.forEach(function(item) {
            formattedResult[item.event.id] = (0, $c57d36d3233524f5$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $c57d36d3233524f5$import$edcaf86a4f533110$2e2bcd8739ae039)({}, item), {
                offsetTop: index * 26
            });
        });
    });
...
var $0491e7111fa05a9f$var$formatOverflowingEvents = function(events, timezone) {
    ...
    events.forEach(function(event) {
        var dateTimeStartAt = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(event.startAt, event.timezoneStartAt || timezone);
        var dateTimeEndAt = (0, $28306200f69a6328$export$6c2618c4afcf6cfb)(event.endAt, event.timezoneStartAt || timezone);
        ...
        for(var i = 0; i <= differenceInDays; i++){
            var dateKey = (0, $bf7b38bce41ca3dd$export$6a8d31c8b7f17aa5)(dateTimeStartAt.plus({
                days: i
            }));
            if (!result[dateKey]) result[dateKey] = [
                event
            ];
            else result[dateKey] = (0, $0491e7111fa05a9f$import$5a5c6451aa60633f$2e2bcd8739ae039)(result[dateKey]).concat([
                event
            ]);
        }
    });
...
var $0491e7111fa05a9f$export$d27f846d3c4971c6 = function(events) {
    return events.sort(function(a, b) {
        var diffA = (0, $cw6c3$luxon.DateTime).fromISO(a.endAt).toMillis() - (0, $cw6c3$luxon.DateTime).fromISO(a.startAt).toMillis();
        var diffB = (0, $cw6c3$luxon.DateTime).fromISO(b.endAt).toMillis() - (0, $cw6c3$luxon.DateTime).fromISO(b.startAt).toMillis();
        if (diffB > diffA) return 1;
        else if (diffB < diffA) return -1;
        return 0;
    });
};
var $0491e7111fa05a9f$var$getMonthRowPosition = function(events, width, calendarDays, timezone, maxEventsVisible) {
    var // eslint-disable-next-line @typescript-eslint/no-unused-vars
    ref;
    var overflowEvents = [];
    var tableSpace = width / 100 * (0, $88a08af890f49243$export$b4e2ba6756dec2c);
    var result = [];
    var usedEvents = [];
    // filter only header events
    var eventsFiltered = [];
    ...
    (ref = Object.entries(events)) === null || ref === void 0 ? void 0 : ref.map(function(param) {
        var _param = (0, $0491e7111fa05a9f$import$a521aa921bda7687$2e2bcd8739ae039)(param, 2), key = _param[0], items = _param[1];
        // @ts-ignore
        items.forEach(function(item) {
            // filter only relevant events
            var isInRange = (0, $585762b051d85803$export$3a6eb9efca632dee)(item, calendarDays, timezone);
    ...
    sortedByLength === null || sortedByLength === void 0 ? void 0 : sortedByLength.forEach(function(event) {
        ...
        sortedByLength.forEach(function(eventToCompare) {
            ...
            if (event.id === eventToCompare.id) return true;
            // check if events are not overlapping
            var isOverlapping = (0, $585762b051d85803$export$c212dd23f1f0a1e3)((0, $c57d36d3233524f5$export$ca41440b93b2a001)(event, timezone), (0, $c57d36d3233524f5$export$ca41440b93b2a001)(eventToCompare, timezone), timezone);
            // found not overlapping matching event
            if (!isOverlapping) {
                var isMatchingAll = true;
                // compare match with other stored events for same row
                rowWithNotOverlappingEvents.forEach(function(itemFromRow) {
                    var isOverlappingAll = (0, $585762b051d85803$export$c212dd23f1f0a1e3)((0, $c57d36d3233524f5$export$ca41440b93b2a001)(itemFromRow, timezone), (0, $c57d36d3233524f5$export$ca41440b93b2a001)(eventToCompare, timezone), timezone);
                    // prevent merging if only one conflict exists
                    if (isOverlappingAll) isMatchingAll = false;
                });
                if (isMatchingAll) {
    ...
    result.forEach(function(events, index) {
        events.forEach(function(item) {
            formattedResult[item.event.id] = (0, $0491e7111fa05a9f$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $0491e7111fa05a9f$import$edcaf86a4f533110$2e2bcd8739ae039)({}, item), {
                offsetTop: index * 25
            });
        });
    });
...
setContext) {
    ...
    calendarDaysRows.forEach(function(row) {
        ...
        overflowingEvents = (0, $0491e7111fa05a9f$import$5a5c6451aa60633f$2e2bcd8739ae039)(overflowingEvents).concat((0, $0491e7111fa05a9f$import$5a5c6451aa60633f$2e2bcd8739ae039)(rowResult.overflowingEvents));
    });
    //
    // setContext(
    //   'monthOverflowEvents',
...
import "c4cfd121d9d256dd:@swc/helpers/lib/_object_spread.js:esm";
import "c4cfd121d9d256dd:@swc/helpers/lib/_sliced_to_array.js:esm";
...
import "05ef8620e2e948fa:@swc/helpers/lib/_sliced_to_array.js:esm";





import "b1f96b393fd4bbd3:@swc/helpers/lib/_sliced_to_array.js:esm";
...
var $b1f96b393fd4bbd3$var$Dropdown = function(props) {
    var ref = (0, $b1f96b393fd4bbd3$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    var translations = store.translations;
    var ref1 = (0, $b1f96b393fd4bbd3$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), isVisible = ref1[0], setVisible = ref1[1];
    var ref2 = (0, $b1f96b393fd4bbd3$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)({
        x: null,
        y: null
...
var $05ef8620e2e948fa$var$MonthViewButtonMore = function(props) {
    var ref = (0, $05ef8620e2e948fa$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref[0], dispatch = ref[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    var renderShowMoreButtons = function() {
        ...
        return calendarDays.map(function(calendarDay) {
            var dateKey = (0, $bf7b38bce41ca3dd$export$6a8d31c8b7f17aa5)(calendarDay);
...
var $c4cfd121d9d256dd$var$MonthWeekRow = function(props) {
    ...
    var ref = (0, $c4cfd121d9d256dd$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 1), store = ref[0];
    ...
    var renderEvents = function(data, i) {
        ...
        return itemRows.map(function(item) {
            return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $b852c5f3008abacb$export$2e2bcd8739ae039), {
                item: (0, $c4cfd121d9d256dd$import$edcaf86a4f533110$2e2bcd8739ae039)({}, item),
                meta: item.meta,
...
var $4e630ae36e00686b$var$renderOneRow = function(days, eventRows, sequence) {
    var rows = (0, $0491e7111fa05a9f$export$89831913a243f8ab)(days);
...
var $4e630ae36e00686b$var$MonthView = function(props) {
    var ref = (0, $4e630ae36e00686b$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), wasInit = ref[0], setWasInit = ref[1];
    var ref1 = (0, $4e630ae36e00686b$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(null), 2), calendarContent = ref1[0], setCalendarContent = ref1[1];
    var events = props.events;
    var ref2 = (0, $4e630ae36e00686b$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref2[0], dispatch = ref2[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    (0, $cw6c3$react.useEffect)(function() {
        if (wasInit && height !== 0) {
            if (!hasExternalLayout) (0, ($parcel$interopDefault($cw6c3$kalendlayout)))({
                ...
                calendarDays: calendarDays,
                config: store.config,
                selectedView: (0, $3f7b2fe5d2c34f8f$export$b573856c46cc9357).MONTH
            }).then(function(res) {
...
var $2c06f9532bb9aaf9$var$Calendar = function(props) {
    var ref = (0, $2c06f9532bb9aaf9$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref[0], dispatch = ref[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    var width = (0, $2c4fe1f6b84a6784$export$3aee49006f13db09)();
    var ref1 = (0, $2c06f9532bb9aaf9$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(""), 2), prevView = ref1[0], setPrevView = ref1[1];
    var ref2 = (0, $2c06f9532bb9aaf9$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(null), 2), viewChanged = ref2[0], setViewChanged = ref2[1];
    (0, $cw6c3$react.useEffect)(function() {
        if (selectedView) {
            var calendarDaysInitial = (0, $1500da26cef85c66$export$e75d169fad6edf5f)(selectedView, selectedDate, config.weekDayStart);
    ...
    (0, $cw6c3$react.useEffect)(function() {
        ...
        var calendarDaysNew = (0, $1500da26cef85c66$export$e75d169fad6edf5f)(viewChangedValue, (0, $cw6c3$luxon.DateTime).now(), config.weekDayStart, setSelectedDate);
        setContext("calendarDays", calendarDaysNew);
        setContext("width", width - (0, $bf7b38bce41ca3dd$export$76c69f043295405f)(viewChanged));
    ...
    (0, $cw6c3$react.useEffect)(function() {
        ...
        if (selectedViewValue && selectedViewValue !== selectedViewValue) {
            ...
            var calendarDaysNew = (0, $1500da26cef85c66$export$e75d169fad6edf5f)(selectedViewValue, (0, $cw6c3$luxon.DateTime).now(), config.weekDayStart, setSelectedDate);
            setContext("calendarDays", calendarDaysNew);
            setContext("width", width - (0, $bf7b38bce41ca3dd$export$76c69f043295405f)(selectedViewValue));
        }
    }, [
        selectedView
    ]);
    ...
    (0, $cw6c3$react.useLayoutEffect)(function() {
        if (callbacks.onPageChange && calendarDays && calendarDays[0] && calendarDays.length > 0) callbacks.onPageChange((0, $2c06f9532bb9aaf9$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $2c06f9532bb9aaf9$import$edcaf86a4f533110$2e2bcd8739ae039)({}, (0, $1500da26cef85c66$export$fef151b94550e9f5)(calendarDays)), {
    ...
    return selectedView && (calendarDays === null || calendarDays === void 0 ? void 0 : calendarDays.length) > 0 && selectedDate ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsxs)((0, $cw6c3$reactjsxruntime.Fragment), {
        children: [
            /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $21db0de5ba63f204$export$2e2bcd8739ae039), {
                setViewChanged: setViewChanged,
                kalendRef: props.kalendRef
            }),
            selectedView !== (0, $e4750b0ebeed8e48$export$ec9758e21af63072).AGENDA ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $58f20473f1f0067a$export$2e2bcd8739ae039), {}) : null,
            /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
                ...
                children: /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsxs)((0, $f89b7b16d8022e68$export$2e2bcd8739ae039), {
                    children: [
                        selectedView === (0, $e4750b0ebeed8e48$export$ec9758e21af63072).MONTH ? /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $4e630ae36e00686b$export$2e2bcd8739ae039), {
...
import "f101c73fee185a96:@swc/helpers/lib/_sliced_to_array.js:esm";




var $f101c73fee185a96$var$DimensionsLayoutLayer = function(props) {
    var ref = (0, $f101c73fee185a96$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref[0], dispatch = ref[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
    ...
    // init context
    (0, $cw6c3$react.useEffect)(function() {
        setContext("width", width - (0, $bf7b38bce41ca3dd$export$76c69f043295405f)(selectedView));
        if (width < 750) setContext("isMobile", true);
        else setContext("isMobile", false);
    }, []);
    (0, $cw6c3$react.useEffect)(function() {
        setContext("width", (0, $2c4fe1f6b84a6784$export$3c49c185de0c2bfc)() - (0, $bf7b38bce41ca3dd$export$76c69f043295405f)(selectedView));
        if (width < 750) setContext("isMobile", true);
        else setContext("isMobile", false);
    }, [
        width
...
var $36362bd2dc53dd73$var$LanguageLayer = function(props) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    var ref = (0, $36362bd2dc53dd73$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useContext)((0, $65553fbba1d6d65b$export$841858b892ce1f4c)), 2), store = ref[0], dispatch = ref[1];
    var setContext = function(type, payload) {
        dispatch({
            type: type,
            payload: payload
...
import "7d02895a6af4de33:@swc/helpers/lib/_sliced_to_array.js:esm";

var $7d02895a6af4de33$var$RootLayoutLayer = function(props) {
    var ref = (0, $7d02895a6af4de33$import$a521aa921bda7687$2e2bcd8739ae039)((0, $cw6c3$react.useState)(false), 2), isMounted = ref[0], setIsMounted = ref[1];
    (0, $cw6c3$react.useEffect)(function() {
        var rootEl = document.querySelector(".Kalend__Calendar__root");
        if (rootEl) setIsMounted(true);
    }, [
...
var $3f7b2fe5d2c34f8f$export$b573856c46cc9357 = (0, $e4750b0ebeed8e48$export$ec9758e21af63072);
var $3f7b2fe5d2c34f8f$export$b6e764c50c031f2a = (0, $63103f0ef67d319d$export$3d0db7ed812b6b3f);
var $3f7b2fe5d2c34f8f$var$Kalend = function(props) {
    // basic validation
    (0, $cw6c3$react.useEffect)(function() {
        (0, $078907888c55a58c$export$45855e0dd982478b)(props);
        (0, $078907888c55a58c$export$fbb8247b2e46a70a)();
    }, []);
    return /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)("div", {
        className: "Kalend__Calendar__root Kalend__main",
        children: /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $65553fbba1d6d65b$export$2e2bcd8739ae039), {
            children: /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $36362bd2dc53dd73$export$2e2bcd8739ae039), {
                ...
                children: /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $7d02895a6af4de33$export$2e2bcd8739ae039), {
                    children: /*#__PURE__*/ (0, $cw6c3$reactjsxruntime.jsx)((0, $3886b97a1526edd3$export$2e2bcd8739ae039), (0, $3f7b2fe5d2c34f8f$import$25ed7b93d4e79a51$2e2bcd8739ae039)((0, $3f7b2fe5d2c34f8f$import$edcaf86a4f533110$2e2bcd8739ae039)({}, props), {
